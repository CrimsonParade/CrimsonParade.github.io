...
function changeLanguage() {
    ...
    <div id="registrationForm">
        ...
        <select id="levelSelector" class="form-control">
            <option value="null" disabled hidden selected>${getLocalizedValue('selectConfirmedLevel')}</option>${getLevelOptions()}
        </select>
        <br>
...
function registerTeacher() {
    ...
    saveTeacher({id, email, name, level, status: 'WAITING', group: ''});
