...
function getDescription() {
    if (language === 'romanian') {
        ...
        <a href="/groups.html">Grupuri</a> - lista grupurilor înregistrați în sistem<br></p>`;
    }
    if (language === 'russian') {
        ...
        <a href="/groups.html">Группы</a> - список групп, зарегистрированных в системе<br></p>`;
    }
    return `<b>Demo version of the management system for the national program of the study of the Romanian language.</b><br>
        ...
        <a href="/groups.html">Groups</a> - list of groups registered in the system<br></p>`;
}
