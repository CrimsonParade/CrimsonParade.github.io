...
const constStudents = [
    {id: '1', email: 'miron@gov.md', name: 'Miron Costin', status: 'IN_PROGRESS', level: 'A2', group: 'A2_VANGHELI_1'},
    {id: '2', email: 'miron@gov.md', name: 'Ștefan cel Mare', status: 'FINISHED', level: 'A1', group: 'A1_DRUȚĂ_1'},
    {id: '3', email: 'miron@scr.ro', name: 'Ion Creangă', status: 'WAITING', level: 'B1', group: ''}];
...
function getStudents() {
    return constStudents.concat(JSON.parse(localStorage.getItem('students')) || []);
}
